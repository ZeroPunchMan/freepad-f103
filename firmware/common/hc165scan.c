...
{
    Mmhl_GpioInit(HC165_CLK_PORT, HC165_CLK_PIN, LL_GPIO_MODE_OUTPUT, LL_GPIO_PULL_UP);
    Mmhl_GpioInit(HC165_LOAD_PORT, HC165_LOAD_PIN, LL_GPIO_MODE_OUTPUT, LL_GPIO_PULL_UP);
    Mmhl_GpioInit(HC165_DAT_PORT, HC165_DAT_PIN, LL_GPIO_MODE_INPUT, LL_GPIO_PULL_DOWN);
